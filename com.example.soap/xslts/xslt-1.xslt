...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:core="http://www.altova.com/MapForce/UDF/core" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="core xs">
		...
		<FACTURA xmlns:stl="http://www.codesynthesis.com/projects/xsstl/xsstl" xmlns:ns2="urn:oasis:names:specification:ubl:codelist:gc:AllowanceChargeReasonCode-2.0" xmlns:ns3="urn:oasis:names:specification:ubl:codelist:gc:PaymentMeansCode-2.0" xmlns:ns1="urn:un:unece:uncefact:codelist:specification:54217:2001" xmlns:clm66411="urn:un:unece:uncefact:codelist:specification:66411:2001">
				...
				<xsl:for-each select="dsxml">
					...
					<xsl:for-each select="informacion_tributaria_emi_xml">
						...
						<TAC>
							...
							<xsl:for-each select="$var28_cur/encabezado_xml">
				...
				<xsl:for-each select="dsxml">
					...
					<xsl:for-each select="informacion_tributaria_adq_xml">
						...
						<TCR>
							...
							<xsl:for-each select="$var67_cur/encabezado_xml">
			...
			<TOT>
				...
				<xsl:for-each select="dsxml/encabezado_xml">
					...
					<TOT_5>
						<xsl:if test="not((translate(valor_total_documento/@xsi:nil, 'true ', '1') = '1'))">
							<xsl:value-of select="number(valor_total_documento)"/>
						</xsl:if>
					</TOT_5>
				</xsl:for-each>
				<xsl:for-each select="dsxml/encabezado_xml">
			...
			<xsl:for-each select="dsxml">
				...
				<xsl:for-each select="resumen_impto_xml">
					...
					<TIM>
						...
						<xsl:for-each select="$var91_cur/encabezado_xml">
			...
			<xsl:for-each select="dsxml">
				...
				<xsl:for-each select="descuento_xml">
					<xsl:variable name="var99_cur" select="."/>
					<DSC>
						<DSC_1>
							<xsl:if test="not((translate(indicador_descuento/@xsi:nil, 'true ', '1') = '1'))">
								<xsl:value-of select="boolean(translate(normalize-space(string(indicador_descuento)), ' 0false', ''))"/>
							</xsl:if>
						</DSC_1>
						<DSC_2>
							<xsl:if test="not((translate(factor_numerico/@xsi:nil, 'true ', '1') = '1'))">
								<xsl:value-of select="number(factor_numerico)"/>
							</xsl:if>
						</DSC_2>
						<DSC_3>
							<xsl:if test="not((translate(valor_descuento/@xsi:nil, 'true ', '1') = '1'))">
								<xsl:value-of select="number(valor_descuento)"/>
							</xsl:if>
						</DSC_3>
						<xsl:for-each select="$var98_cur/encabezado_xml">
						...
						<DSC_5>
							<xsl:if test="not((translate(tipo_descuento_homo/@xsi:nil, 'true ', '1') = '1'))">
								<xsl:value-of select="tipo_descuento_homo"/>
							</xsl:if>
						</DSC_5>
						<DSC_6>
							<xsl:if test="not((translate(descripcion_descuento/@xsi:nil, 'true ', '1') = '1'))">
								<xsl:value-of select="descripcion_descuento"/>
							</xsl:if>
						</DSC_6>
						<xsl:for-each select="$var98_cur/encabezado_xml">
						...
						<DSC_9>
							<xsl:if test="not((translate(secuencia_impuesto/@xsi:nil, 'true ', '1') = '1'))">
								<xsl:value-of select="number(secuencia_impuesto)"/>
							</xsl:if>
						</DSC_9>
					</DSC>
				</xsl:for-each>
			...
			<TET>
				<xsl:for-each select="dsxml/desgloce_neg_xml">
			...
			<xsl:for-each select="dsxml">
				...
				<xsl:for-each select="detalle_xml">
					...
					<ITE>
						...
						<xsl:for-each select="$var127_cur/encabezado_xml">
						...
						<ITE_7>
							<xsl:if test="not((translate(precio_unitario_comercial/@xsi:nil, 'true ', '1') = '1'))">
								<xsl:value-of select="number(precio_unitario_comercial)"/>
							</xsl:if>
						</ITE_7>
						<xsl:for-each select="$var127_cur/encabezado_xml">
						...
						<xsl:if test="not((translate(descripcion_unidad_un/@xsi:nil, 'true ', '1') = '1'))">
							<xsl:for-each select="$var127_cur/encabezado_xml">
								...
								<xsl:choose>
									<xsl:when test="(translate(codigo_moneda_emisor/@xsi:nil, 'true ', '1') = '1')"/>
									<xsl:when test="(codigo_moneda_emisor = 'COP')">
										<xsl:choose>
											<xsl:when test="(translate($var128_cur/precio_neto_bg/@xsi:nil, 'true ', '1') = '1')"/>
											<xsl:when test="not((translate($var128_cur/cantidad_item/@xsi:nil, 'true ', '1') = '1'))">
												<ITE_10>
													<xsl:value-of select="concat($var128_cur/descripcion_unidad_un, '|', round(($var128_cur/precio_neto_bg div $var128_cur/cantidad_item)))"/>
												</ITE_10>
											</xsl:when>
										</xsl:choose>
									</xsl:when>
									...
									<xsl:when test="not((translate($var128_cur/cantidad_item/@xsi:nil, 'true ', '1') = '1'))">
										<ITE_10>
											<xsl:variable name="var132_nested" select="format-number(($var128_cur/precio_neto_bg div $var128_cur/cantidad_item), '0.##')"/>
											...
											<xsl:value-of select="concat($var128_cur/descripcion_unidad_un, '|', translate($var132_nested, '.,', concat($var133_nested, $var134_nested)))"/>
										</ITE_10>
									</xsl:when>
								</xsl:choose>
							</xsl:for-each>
						...
						<ITE_21>
							<xsl:if test="not((translate(precio_neto_bg/@xsi:nil, 'true ', '1') = '1'))">
								<xsl:value-of select="number(precio_neto_bg)"/>
							</xsl:if>
						</ITE_21>
						<xsl:for-each select="$var127_cur/encabezado_xml">
						...
						<xsl:for-each select="item_descuentos_xml">
							...
							<IDE>
								...
								<IDE_4>
									<xsl:if test="not((translate(codigo_descuento_homo/@xsi:nil, 'true ', '1') = '1'))">
										<xsl:value-of select="codigo_descuento_homo"/>
									</xsl:if>
								</IDE_4>
								<IDE_5>
									<xsl:if test="not((translate(tipo_descuento_homo/@xsi:nil, 'true ', '1') = '1'))">
								...
								<IDE_6>
									<xsl:if test="not((translate(porcentaje_descuento/@xsi:nil, 'true ', '1') = '1'))">
										<xsl:value-of select="number(porcentaje_descuento)"/>
									</xsl:if>
								</IDE_6>
								<IDE_7>
									<xsl:if test="not((translate($var128_cur/impuesto_total_item/@xsi:nil, 'true ', '1') = '1'))">
										<xsl:value-of select="number($var128_cur/impuesto_total_item)"/>
									</xsl:if>
								</IDE_7>
								<xsl:for-each select="$var127_cur/encabezado_xml">
								...
								<IDE_9>
									<xsl:if test="not((translate(secuencia_descuento/@xsi:nil, 'true ', '1') = '1'))">
										<xsl:value-of select="number(secuencia_descuento)"/>
									</xsl:if>
								</IDE_9>
							</IDE>
						</xsl:for-each>
