 ...
 * generated in the com.grasco.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _DoTest_QNAME = new QName("http://services.grasco.com/", "doTest");
    private final static QName _Consulta_QNAME = new QName("http://services.grasco.com/", "consulta");
    private final static QName _DoTestResponse_QNAME = new QName("http://services.grasco.com/", "doTestResponse");
    private final static QName _GetaddEmision_QNAME = new QName("http://services.grasco.com/", "getaddEmision");
    private final static QName _GetaddEmisionResponse_QNAME = new QName("http://services.grasco.com/", "getaddEmisionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.grasco.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.grasco.com/", name = "doTest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.grasco.com/", name = "consulta")
    public JAXBElement<DoTest> createConsulta(DoTest value) {
        return new JAXBElement<DoTest>(_Consulta_QNAME, DoTest.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.grasco.com/", name = "doTestResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.grasco.com/", name = "getaddEmision")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.grasco.com/", name = "getaddEmisionResponse")
